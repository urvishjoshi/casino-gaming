...
<head>
	<meta charset="UTF-8">
	<title>Casino Gaming Registeration</title>
...
<body>
	...
	<div class="container mt-4">
		<div class="row justify-content-center">
			<div class="col-md-4">
				<div class="card">
					<div class="card-header bg-primary text-white">Player Registration</div>
					<div>
						<div class="card-body">
							<form action="process/registerProcess.php" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" for="name" name="name" id="name" class="form-control" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" for="phone" name="phone" id="phone" class="form-control" required>
								</div>
								<div class="row justify-content-center">
				...
				<center>or<br>- <a href="index.php" class="link">Login</a> here as existing player -</center>
			</div>
		</div>
	</div>
